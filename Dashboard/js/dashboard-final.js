...
// Optional: Tooltip triggers for chart bars
...
// Drill-Down Modal Functions (Placeholder)
function drillDownMonth(month) {
    alert('ðŸ“Š Opening detailed breakdown for ' + month + '...\n\nIn production: Modal would show:\n- Daily revenue data\n- Top 10 clients\n- Product category breakdown\n- Regional contribution');
...
function explainChart() {
    const explanation = `
ðŸ“Š REVENUE & PROFIT TREND ANALYSIS
...
ðŸ“ˆ INSIGHT: Revenue peaks align with Indian fiscal/festive calendars, not just business demand.
    `;
    alert(explanation);
}
...
function drillDownCategory(categoryName) {
    ...
    // Update modal content based on selected category
    ...
    if (categoryName === 'Electronics') {
        document.getElementById('drillDownContent').innerHTML = `
            <div class="space-y-4">
                <div class="bg-slate-50 dark:bg-slate-700/50 p-4 rounded-lg">
                    <p class="text-sm font-bold text-slate-900 dark:text-white mb-3">ðŸ“± Top Products</p>
                    <div class="space-y-2">
                ...
                <div class="bg-slate-50 dark:bg-slate-700/50 p-4 rounded-lg">
                    <p class="text-sm font-bold text-slate-900 dark:text-white mb-3">ðŸ“ˆ Monthly Breakdown</p>
                    <div class="space-y-1 text-sm">
                        <div class="flex justify-between">
                            <span>Jan-Mar</span>
                            <span class="font-bold">â‚¹3.2L</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Apr-Jun</span>
                            <span class="font-bold">â‚¹4.1L</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Jul-Sep</span>
                            <span class="font-bold">â‚¹3.5L</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Oct-Dec</span>
                            <span class="font-bold">â‚¹2.6L</span>
                        </div>
                    </div>
                </div>
                
                <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                    <p class="text-sm font-bold text-blue-900 dark:text-blue-300 mb-2">ðŸ’¡ Growth Trend</p>
        ...
        document.getElementById('drillDownContent').innerHTML = `
            <div class="space-y-4">
                <div class="bg-slate-50 dark:bg-slate-700/50 p-4 rounded-lg">
                    <p class="text-sm font-bold text-slate-900 dark:text-white mb-3">ðŸ›‹ï¸ Top Products</p>
                    <div class="space-y-2">
                        <div class="flex justify-between items-center text-sm">
                ...
                <div class="bg-slate-50 dark:bg-slate-700/50 p-4 rounded-lg">
                    ...
                    <div class="space-y-1 text-sm">
                        <div class="flex justify-between">
                            <span>Jan-Mar</span>
                            <span class="font-bold">â‚¹1.8L</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Apr-Jun</span>
                            <span class="font-bold">â‚¹2.2L</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Jul-Sep</span>
                            <span class="font-bold">â‚¹2.1L</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Oct-Dec</span>
                            <span class="font-bold">â‚¹1.9L</span>
                        </div>
                    </div>
                </div>
                
                <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                    <p class="text-sm font-bold text-green-900 dark:text-green-300 mb-2">ðŸ’¡ Growth Trend</p>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-slate-50 dark:bg-slate-700/50 p-4 rounded-lg">
                    ...
                    <div class="space-y-1 text-sm">
                        <div class="flex justify-between">
                            <span>Jan-Mar</span>
                            <span class="font-bold">â‚¹1.2L</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Apr-Jun</span>
                            <span class="font-bold">â‚¹1.4L</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Jul-Sep</span>
                            <span class="font-bold">â‚¹1.3L</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Oct-Dec</span>
                            <span class="font-bold">â‚¹1.4L</span>
                ...
                <div class="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg border border-orange-200 dark:border-orange-800">
                    <p class="text-sm font-bold text-orange-900 dark:text-orange-300 mb-2">ðŸ’¡ Growth Trend</p>
